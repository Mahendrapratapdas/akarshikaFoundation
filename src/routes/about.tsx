...
import team1 from "@/assets/hero1.jpeg";
import team2 from "@/assets/hero2.jpeg";
import team3 from "@/assets/hero3.jpeg";
import {
  ABOUT_HEADING_1,
      ...
      <section className="border-t border-border/60 bg-secondary/30">
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {details.team.map((m) => (
              <article key={m.name} className=" mx-auto w-full max-w-[280px] overflow-hidden rounded-2xl border border-border/60 bg-card transition hover:-translate-y-1 hover:shadow-[var(--shadow-elegant)]">
